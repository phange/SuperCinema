module.exports = function(){
    ...
    // this function returns the entire Movies database in an object 'results' assigned to context.movies
    ...
    //             res.end();
    //         }
    //         context.movies = results;  // changed context.people to context.movies
    //         complete();
    //     });
    // }

    // Filter by homeworld function
    // can ignore this one
    ...
    // probably from search bar.. can ignore for now
    ...
    // this route is for the insert/add
    ...
    // // this route is for insert/add.. because of the query shown below. do later
    // // modified for movies
    // router.post('/', function(req, res){
    //     console.log(req.body.homeworld)
    //     console.log(req.body)
    ...
    // router.delete('/:id', function(req, res){
    //     var mysql = req.app.get('mysql');
    //     var sql = "DELETE FROM Movies WHERE character_id = ?";   //movieID or id? where is this coming from?
    //     var inserts = [req.params.id];
    //     sql = mysql.pool.query(sql, inserts, function(error, results, fields){
    //         if(error){
    //             console.log(error)
